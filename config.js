...
export const QUIZ_DATA = {
  ...
  D4: [
    { q: "The term 'public virtue' implies?", options: { A: "Loyalty to political superiors", B: "Courage to act for the public good despite personal loss", C: "Following orders without questioning", D: "Avoiding personal criticism" } },
    { q: "The essence of integrity testing is to?", options: { A: "Detect corruption through traps", B: "Assess moral character consistency", C: "Promote secrecy", D: "Encourage competition" } },
    { q: "Probity in governance implies?", options: { A: "Public life conducted with transparency and accountability", B: "Rigid obedience", C: "Blind loyalty", D: "Fear of punishment" } },
    { q: "Vigilance angle does not include?", options: { A: "Irregularities in financial transactions", B: "Administrative inefficiency", C: "Illegal gratification", D: "Disproportionate assets" } },
    { q: "Deontological ethics emphasizes?", options: { A: "Consequences", B: "Duties and moral obligations", C: "Personal pleasure", D: "Public opinion" } },
    { q: "Good governance requires?", options: { A: "Transparency and accountability", B: "Strict secrecy", C: "Delay in decision-making", D: "Political patronage" } },
    { q: "Ethical fading means?", options: { A: "Ignoring moral dimension due to pressure", B: "Applying ethics excessively", C: "Avoiding decision", D: "Following morality blindly" } },
    { q: "Reporting misuse of government vehicle by senior through proper channel indicates?", options: { A: "Disobedience", B: "Moral courage", C: "Mutiny", D: "Political bias" } },
    { q: "Code of Conduct differs from Code of Ethics in that?", options: { A: "It prescribes punishments", B: "It is advisory and broader in spirit", C: "It is legally binding", D: "It applies only to ministers" } },
    { q: "A culture of integrity in public service is best promoted by?", options: { A: "Periodic vigilance checks", B: "Leadership by moral example and value-based training", C: "Strict surveillance", D: "Rewarding loyalty" } },
  ],
};
